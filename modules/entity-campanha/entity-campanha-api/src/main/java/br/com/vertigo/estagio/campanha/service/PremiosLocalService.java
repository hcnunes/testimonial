...
/**
 * Provides the local service interface for Premios. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PremiosLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PremiosLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PremiosLocalServiceUtil} to access the premios local service. Add custom service methods to <code>br.com.vertigo.estagio.campanha.service.impl.PremiosLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public Premios addPremios(
			long premiosId, long groupId, long companyId, long userId,
			String userName, Date createDate, Date modifiedDate, String nome,
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Premios addPremios(Premios premios);
	...
	public Premios createPremios(long premiosId);
	...
	public Premios deletePremios(long premiosId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Premios deletePremios(Premios premios);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Premios fetchPremios(long premiosId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Premios getPremios(long premiosId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Premios> getPremioses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Premios updatePremios(Premios premios);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Premios updatePremios(long premiosId, Date modifiedDate, String nome, 
			String descricao, long fileEntryId, String fileUrl) throws PortalException ;
