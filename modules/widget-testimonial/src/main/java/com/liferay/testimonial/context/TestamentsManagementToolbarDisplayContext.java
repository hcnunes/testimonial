 ...
 * 
 */
public class TestamentsManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {

    private final PortalPreferences _portalPreferences;
    private final ThemeDisplay _themeDisplay;
	
    public TestamentsManagementToolbarDisplayContext(
                ...
                addDropdownItem(
                        dropdownItem -> {
                            dropdownItem.setHref(
                                    ...
                                    "mvcRenderCommandName", MVCCommandKeys.UPDATE_TESTAMENT,
                                    "redirect", currentURLObj.toString());
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "add-testament"));
                        });
            }
        };
    }
    ...
    /**
     * Returns the testament list display style.
     *
    ...
    public String getDisplayStyle() {
        ...
        if (Validator.isNull(displayStyle)) {
            displayStyle = _portalPreferences.getValue(
                    TestimonialPortletKeys.TESTIMONIAL, "testaments-display-style",
                    "descriptive");
        }
        else {
    ...
    public String getOrderByCol() {
        ...
        return ParamUtil.getString(request, "orderByCol", "dueDate");
    }
    ...
    public String getSearchActionURL() {
        ...
        searchURL.setProperty(
                "mvcRenderCommandName", MVCCommandKeys.VIEW_TESTAMENTS);
    ...
    public List<ViewTypeItem> getViewTypeItems() {
        ...
        String orderByCol =
                ParamUtil.getString(request, "orderByCol", "dueDate");
        String orderByType =
...
//                            dropdownItem.setLabel(
//                                    LanguageUtil.get(request, "dueDate"));
//                        });
//
//                add(
//                        dropdownItem -> {
...
//    }
    ...
    private PortletURL _getCurrentSortingURL() throws PortletException {
        ...
        sortingURL.getRenderParameters().setValue("mvcRenderCommandName", MVCCommandKeys.VIEW_TESTAMENTS);
