...
@Component(immediate = true, service = TestamentMessagingConfigurator.class)
public class TestamentMessagingConfigurator {
	...
	protected void activate(BundleContext bundleContext) {
		...
		DestinationConfiguration destinationConfiguration = new DestinationConfiguration(
				DestinationConfiguration.DESTINATION_TYPE_PARALLEL, "testimonialDestination");
