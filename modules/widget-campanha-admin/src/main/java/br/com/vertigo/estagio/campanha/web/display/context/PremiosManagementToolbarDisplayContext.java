package br.com.vertigo.estagio.campanha.web.display.context;
...
import br.com.vertigo.estagio.campanha.web.admin.internal.security.permission.resource.PromocaoTopLevelPermission;
 ...
 * 
 */
public class PremiosManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {

    private final PortalPreferences _portalPreferences;
    private final ThemeDisplay _themeDisplay;
    private long promocaoId;
	
    public PremiosManagementToolbarDisplayContext(
        ...
        promocaoId = ParamUtil.getLong(liferayPortletRequest, "promocaoId");
    }
    ...
    public CreationMenu getCreationMenu() {
        ...
        if (!PromocaoTopLevelPermission.contains(
                ...
                addDropdownItem(
                        dropdownItem -> {
                            ...
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "add-premio"));
                        });
            }
        };
    }
    ...
    /**
     * Returns the premio list display style.
     *
    ...
    public String getDisplayStyle() {
        ...
        if (Validator.isNull(displayStyle)) {
            displayStyle = _portalPreferences.getValue(
                    CampanhaAdminPortletKeys.CAMPANHAADMIN, "premios-display-style",
                    "descriptive");
        }
        else {
    ...
    public String getOrderByCol() {
        ...
        return ParamUtil.getString(request, "orderByCol", "nome");
    }
    ...
    public String getSearchActionURL() {
        ...
        searchURL.setProperty(
                "mvcRenderCommandName", MVCCommandKeys.VIEW_PREMIOS);
    ...
    public List<ViewTypeItem> getViewTypeItems() {
        ...
        String orderByCol =
                ParamUtil.getString(request, "orderByCol", "nome");
        String orderByType =
...
//                add(
//                        dropdownItem -> {
//                            dropdownItem.setActive("nome".equals(getOrderByCol()));
//                            dropdownItem.setHref(
//                                    _getCurrentSortingURL(), "orderByCol", "nome");
//                            dropdownItem.setLabel(
//                                    LanguageUtil.get(request, "nome"));
//                        });
//
//                add(
//                        dropdownItem -> {
...
//    }
    ...
    private PortletURL _getCurrentSortingURL() throws PortletException {
        ...
        sortingURL.getRenderParameters().setValue("mvcRenderCommandName", MVCCommandKeys.VIEW_PREMIOS);
