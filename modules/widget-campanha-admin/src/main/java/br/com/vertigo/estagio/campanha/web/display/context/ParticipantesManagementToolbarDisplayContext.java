 ...
 * 
 */
public class ParticipantesManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {

    private final PortalPreferences _portalPreferences;
    private final ThemeDisplay _themeDisplay;
	
    public ParticipantesManagementToolbarDisplayContext(
                ...
                addDropdownItem(
                        dropdownItem -> {
                            ...
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "add-participante"));
                        });
            }
        };
    }
    ...
    /**
     * Returns the participante list display style.
     *
    ...
    public String getDisplayStyle() {
        ...
        if (Validator.isNull(displayStyle)) {
            displayStyle = _portalPreferences.getValue(
                    CampanhaAdminPortletKeys.CAMPANHAADMIN, "participantes-display-style",
                    "descriptive");
        }
        else {
    ...
    public String getSearchActionURL() {
        ...
        searchURL.setProperty(
                "mvcRenderCommandName", MVCCommandKeys.VIEW_PARTICIPANTES);
...
//    }
    ...
    private PortletURL _getCurrentSortingURL() throws PortletException {
        ...
        sortingURL.getRenderParameters().setValue("mvcRenderCommandName", MVCCommandKeys.VIEW_PARTICIPANTES);
