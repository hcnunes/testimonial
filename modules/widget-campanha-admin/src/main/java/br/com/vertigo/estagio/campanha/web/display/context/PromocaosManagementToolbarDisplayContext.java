 ...
 * 
 */
public class PromocaosManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {

    private final PortalPreferences _portalPreferences;
    private final ThemeDisplay _themeDisplay;
	
    public PromocaosManagementToolbarDisplayContext(
                ...
                addDropdownItem(
                        dropdownItem -> {
                            ...
                            dropdownItem.setLabel(
                                    LanguageUtil.get(request, "add-promocao"));
                        });
            }
        };
    }
    ...
    /**
     * Returns the promocao list display style.
     *
    ...
    public String getDisplayStyle() {
        ...
        if (Validator.isNull(displayStyle)) {
            displayStyle = _portalPreferences.getValue(
                    CampanhaAdminPortletKeys.CAMPANHAADMIN, "promocaos-display-style",
                    "descriptive");
        }
        else {
    ...
    public String getSearchActionURL() {
        ...
        searchURL.setProperty(
                "mvcRenderCommandName", MVCCommandKeys.VIEW_PROMOCAOS);
...
//    }
    ...
    private PortletURL _getCurrentSortingURL() throws PortletException {
        ...
        sortingURL.getRenderParameters().setValue("mvcRenderCommandName", MVCCommandKeys.VIEW_PROMOCAOS);
