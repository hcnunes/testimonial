...
/**
 * Provides the local service interface for Testament. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TestamentLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TestamentLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestamentLocalServiceUtil} to access the testament local service. Add custom service methods to <code>com.liferay.testimonial.service.impl.TestamentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Testament addTestament(
			long groupId, long companyId, ServiceContext serviceContext,
			String title, String message, Date dueDate)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Testament> getTestamentByUserId(long userId)
	...
	@Indexable(type = IndexableType.REINDEX)
	public Testament updateTestament(
			long testamentId, String title, String message, Date dueDate)
		throws PortalException;
